...
import { db } from "../services/firebase/config"; // ← apna firebase config path yahan adjust karo
import { getAuth } from "firebase/auth";  // ← Firebase Auth import
import { PinIcon, PinnedIcon, ThoughtIcon, TodoIcon, QuoteIcon, ReminderIcon, EditIcon, DeleteIcon, SparklesIcon, ReplyIcon, SearchIcon, FlowerIcon } from "../components/common/Icons";
      ...
      >
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 12, justifyContent: "flex-end" }}>
          <button
            onClick={onClose}
            style={{
              background: "transparent", border: "1px solid rgba(128,128,128,0.22)",
      ...
      >
        ...
        {hover && isOwner && (
          <div style={{ position: "absolute", top: 8, right: 10, display: "flex", gap: 4, animation: "fadeIn 0.15s ease" }}>
            ...
            <ActionBtn icon={<DeleteIcon size={14} />}                          title="Delete"                           onClick={() => onDelete(note.id)} color="#ff6464"      />
          </div>
        )}
    ...
    return (
      <button
        ...
        style={{
          ...
          border: "1.5px dashed rgba(255,182,193,0.25)",
          borderRadius: 18, color: "rgba(255,182,193,0.6)",
          fontSize: 13, cursor: "pointer", textAlign: "left",
          transition: "all 0.2s", letterSpacing: 0.3, fontFamily: "inherit",
          display: "flex", alignItems: "center", gap: 8,
        }}
        onMouseEnter={e => { e.currentTarget.style.background = "rgba(255,182,193,0.1)"; e.currentTarget.style.borderColor = "rgba(255,182,193,0.45)"; }}
        onMouseLeave={e => { e.currentTarget.style.background = "rgba(255,182,193,0.06)"; e.currentTarget.style.borderColor = "rgba(255,182,193,0.25)"; }}
      >
  ...
  return (
    <button
      ...
      style={{
        ...
        background:  active ? "rgba(255,182,193,0.18)" : "rgba(128,128,128,0.08)",
        border:      active ? "1px solid rgba(255,182,193,0.4)" : "1px solid rgba(128,128,128,0.15)",
        color:       active ? "#ffb6c1" : "var(--text-color)",
    ...
    <div style={{ padding: "16px 20px 40px" }}>
      ...
      <div style={{ marginBottom: 16 }}>
        <h2 style={{
          ...
          background: "linear-gradient(135deg, #ffb6c1, #c8aaff, #96e6c8)",
      ...
      {notes.length === 0 ? (
        <div style={{ textAlign: "center", padding: "50px 20px" }}>
          <div style={{ marginBottom: 12, display: "flex", justifyContent: "center" }}><FlowerIcon size={40} color="#ffb6c1" /></div>
