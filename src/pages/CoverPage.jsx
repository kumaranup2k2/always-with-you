  ...
  return (
    <div style={{
      ...
      <div className="glass-panel" style={{
        ...
        <p style={{ fontSize: 11, color: "rgba(255,255,255,0.45)", marginBottom: 24, lineHeight: 1.6 }}>
          Set up your profile to get started
        </p>

        <div style={{ marginBottom: 14, textAlign: "left" }}>
          <label style={{ fontSize: 10, color: "rgba(255,255,255,0.45)", letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 6 }}>
            Your Name
          </label>
          <input
        ...
        <div style={{ marginBottom: 20, textAlign: "left" }}>
          ...
          <div style={{ position: "relative" }}>
            <span style={{
              ...
              color: "rgba(255,182,193,0.6)", fontSize: 14, pointerEvents: "none"
            }}>@</span>
            <input
              className="glass-input"
    ...
    <>
      ...
      <div style={{
        ...
        <div className="glass-panel" style={{
          ...
          {isBirthday && (
            <div style={{ fontSize: 10, color: "#ffb6c1", marginTop: 6, letterSpacing: 1 }}>
              ✦ Happy Birthday ✦
            </div>
          )}
